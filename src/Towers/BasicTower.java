...
public class BasicTower extends Tower {
	 ...
	 */
	static int damagez = 20;
	/**
	 * holds the default fire rate for this tower
	 */
	static int fireRatez = 30;
	/**
	 ...
	 */
	static int defaultDamagezIncrease=10;
	/**
	 ...
	 * @param columnz
	 */
	public BasicTower(int rowz, int columnz, GameWorld worldz) {
		super(rowz, columnz, rangez, damagez, cost, fireRatez,
				defaultRangezIncrease, defaultDamagezIncrease,
				defaultFireRatezIncrease, "Baisc Tower",  worldz);
